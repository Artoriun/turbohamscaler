...
export const ja: Dictionary = {
  ...
  home: {
    ...
    startNote:
      '組織を 2 つ用意してあるのには理由があります。TurboHam でサインインすると、もう一方のプロジェクトもメンバーも監査ログも、そもそも存在しません。巣穴は別々で、つなぐトンネルはなく、覚えておくフィルターも、忘れると危ないフラグもありません。',
    footer:
    ...
    features: {
      ...
      nothing: {
        title: '何も食べずに動く',
        body: 'アカウントもコンテナもネイティブビルドも不要。インストールしてシードすれば、組織が 2 つ入った動くアプリが手に入ります。ハムスターより餌代がかかりません。',
      },
      pipeline: {
        title: '黙って通さないパイプライン',
        body: 'Lint、型、テナンシーガード、ユニットと API のテスト、バンドルと画像の予算、3 種類のデータベースに対する API テスト、そしてブラウザテストを 2 回 — 開発サーバーとビルド成果物の両方に対して実行します。',
      },
    },
  },
